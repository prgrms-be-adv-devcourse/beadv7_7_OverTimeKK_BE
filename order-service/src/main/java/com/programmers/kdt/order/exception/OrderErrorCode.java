...
public enum OrderErrorCode implements ErrorCode {
    ...
    INVALID_ORDER_AMOUNT(HttpStatus.BAD_REQUEST, "ORD400_3", "주문 금액은 0보다 커야 합니다."),
    ORDER_ITEMS_REQUIRED(HttpStatus.BAD_REQUEST, "ORD400_4", "주문할 상품이 없습니다."),
    ORDER_NOT_FOUND(HttpStatus.NOT_FOUND, "ORD404_1", "주문을 찾을 수 없습니다."),
