...
public enum PerformanceErrorCode implements ErrorCode {
    ...
    PERFORMANCE_SESSION_NOT_FOUND(HttpStatus.UNPROCESSABLE_CONTENT, "P422_002", "공연 회차 정보를 찾을 수 없습니다."),
    PERFORMANCE_SESSION_NOT_VALID(HttpStatus.UNPROCESSABLE_CONTENT, "P422_010", "공연 정보가 유효하지 않습니다."),
    PERFORMANCE_SESSION_INVALID_START_TIME(HttpStatus.UNPROCESSABLE_CONTENT, "P422_011", "공연 시작 시간은 현재보다 이후여야 합니다."),
