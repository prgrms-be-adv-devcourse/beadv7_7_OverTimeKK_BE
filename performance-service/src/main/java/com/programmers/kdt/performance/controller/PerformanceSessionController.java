...
public class PerformanceSessionController {
    ...
    @PostMapping("/session")
    public ApiResponse<?> registerPerformanceSession(@RequestBody PerformanceSessionRequest request) {
        PerformanceSessionResponse response = performanceSessionService.registerPerformanceSession(request);
        return ApiResponse.success(response);
    }

    @PutMapping("/session")
    public ApiResponse<?> changePerformanceSession(@RequestBody PerformanceSessionRequest request) {
    ...
    public ApiResponse<?> getPerformanceSessions(@PathVariable Long performanceId) {
    ...
    public ApiResponse<?> getPerformanceSession(@PathVariable Long performanceId, @PathVariable Long sessionNum) {
    ...
    public ApiResponse<?> deletePerformanceSession(@PathVariable Long performanceId, @PathVariable Long sessionNum) {
